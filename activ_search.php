...
EOM;
        ...
        <div class="box box-success box-solid">
          ...
          <div class="box-body">
            ...
            <p class="text-muted">岩手県の海岸清掃プロジェクト<?php echo $activ_name; ?></p>

            <strong><i class="fa fa-book margin-r-5"></i> 概要</strong>
            <p class="text-muted">岩手県の海岸5か所を清掃するプロジェクト<?php echo $activ_details; ?></p>

            <strong><i class="fa fa-map-marker margin-r-5"></i> 対象</strong>
            <p class="text-muted">海岸漂着ごみ<?php echo $activ_target; ?></p>

 	<strong><i class="fa fa-map-marker margin-r-5"></i> 対象概要</strong>
            <p class="text-muted">岩手県の海岸沿いにある漂着ごみ<?php echo $activ_overview; ?></p>



            <strong><i class="fa fa-file-text-o margin-r-5"></i> 期間</strong>
            <p class="text-muted"><?php echo $start; ?>1月 ～ <?php echo $end; ?>12月</p>
          </div>
          <!-- /.box-body -->
        </div>
...
　　
              ...
              <div class="form-group">
                <label>活動前の画像</label>
                <small>　下のボタンを押して活動の画像を選択します。</small>
                <div class="input-group date">
                  <!-- <div class="input-group-addon">
                    <i class="fa fa-user"></i>
                  </div> -->
  ...
  <label>コメント</label>
        ...
        <button id="submit" type="button" onClick="imgUpload();" class="btn btn-block btn-success btn-lg">調査結果を報告する</button>
      </section>
      <!-- /.content -->
    </div>
    <!-- /.content-wrapper -->
