    ...
    <div class="content-wrapper">
      ...
      <section class="content">
        ...
        if (!empty($_SESSION['message'])) {
            $errorMessage = htmlspecialchars($_SESSION['message'], ENT_QUOTES);
            echo <<<EOM
...
EOM;
        ...
        <div class="box box-widget widget-user">
          ...
          <div class="widget-user-header bg-teal-active">
            <h3 class="widget-user-username"><?php echo $value['activ_name']; ?> <?php echo $researchYear; ?></h3>
          ...
          <div class="box-footer">
            ...
            <p class="text-muted"><?php echo $value['activ_details']; ?></p>

            <strong><i class="fa fa-map-marker margin-r-5"></i> 対種</strong>
            <p class="text-muted"><?php echo $value['activ_name']; ?></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
              <div class="inner">
                <h3><?php echo $activ_Date; ?><sup style="font-size: 20px"></sup></h3>
                <p>調査開始日</p>
              </div>
              <div class="icon">
        ...
        <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-6">
                  <button type="button" name="button" class="btn btn-primary btn-block btn-lg" onclick="location.href='activ_search3.php?id=<?php echo $value['activityID']; ?>'">報告を行う</button>
                </div>
                <!-- <div class="col-xs-6">
