    ...
    if (isset($_GET['report'])) {
        ...
        try {
            ...
            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                // 報告情報の取得
                $stmt = $pdo->prepare('SELECT * FROM debris_report LEFT JOIN debris_type on debris_report.debris_reID = debris_type.debris_reID WHERE debrisID = ? && debris_report.debris_reID = ?');
                $stmt->execute(array($debrisID, $debris_reID));
                ...
                if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    //   'id' => $row['activ_reID'],
                      ...
                      'date' => $row['date'],
                    //   'private' => $row['private'],
                    'debris_user' => $row['debris_user'],
                    'comment' => $row['comment'],
                      'debris_sea' => $row['debris_sea'],
                      'debris_mol' => $row['debris_mol']);
                    ...
                    $stmt = $pdo->prepare('SELECT * FROM debris_media WHERE debris_reID = ?');
                    $stmt->execute(array($debris_reID));

                    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                       $debris_media1 = $row['debris_media1'];
                       $debris_media2 = $row['debris_media2'];
                       $debris_media3 = $row['debris_media3'];
            ...
            <div class="box box-primary">
              ...
              <div class="box-body no-padding">
                <div class="mailbox-read-info">
                  <h5><a href="debris_research-top.php?id=<?php echo $debrisID; ?>"><i class="fa fa-angle-left margin-r-5"></i> 報告一覧に戻る</a>
                  ...
                  <div class="mailbox-read-message">
                    ...
                    <div class="row">
                      <div class="col-sm-3 col-xs-6">
                        ...
                        <p class="text-muted"><?php echo $report['debris_user']; ?></p>
                      </div>

                      <div class="col-sm-3 col-xs-6">
                        <strong><i class="fa fa-book margin-r-5"></i> 報告日</strong>
                        <p class="text-muted"><?php echo $report['date']; ?></p>
                      </div>

                      <div class="col-sm-3 col-xs-6">
                        <strong><i class="fa fa-book margin-r-5"></i> コメント</strong>
                        <p class="text-muted"><?php echo $report['comment']; ?></p><br>
                      </div>

                      <div class="col-sm-3 col-xs-6">
                        <strong><i class="fa fa-book margin-r-5"></i> ごみの量</strong>
                        <p class="text-muted"><?php echo $report['debris_mol']; ?></p><br>
                      </div>

                      <div class="col-sm-3 col-xs-6">
                        <strong><i class="fa fa-book margin-r-5"></i> ごみの種類</strong>
                        <p class="text-muted"><?php echo $report['debris_sea']; ?></p>
                      </div>
                ...
                <div class="row margin">
                  <div class="col-md-9">
                    <h4>報告画像</h4>
                     ...
                     <img src="<?php echo $debris_media1;?>" width="200" height="200"
                     alt="title" onerror="this.style.display='none'"/>
                     <img src="<?php echo $debris_media2;?>" width="200" height="200"　
                     alt="title" onerror="this.style.display='none'"/>
                     <img src="<?php echo $debris_media3;?>" width="200" height="200"　
                     alt="title" onerror="this.style.display='none'"/>
