...
if (isset($_GET['id'])) {
    if (isset($_GET['report'])) {
        ...
        try {
            ...
            if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                ...
                // 報告情報の取得
                $stmt = $pdo->prepare('SELECT * FROM media_report LEFT JOIN media_media on media_report.media_reID = media_media.media_reID WHERE mediaID = ? && media_report.media_reID = ?');
                $stmt->execute(array($mediaID, $media_reID));
                ...
                if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    $stmt = $pdo->prepare('SELECT * FROM media_media WHERE media_reID = ?');
                    $stmt->execute(array($media_reID));
                ...
                $_SESSION['message'] = "この調査は存在しません。1";
    ...
    $_SESSION['message'] = "この調査は存在しません。2";
    header("Location: index.php");  // メイン画面へ遷移
    exit();
}
            ...
            <div class="box box-primary">
              ...
              <div class="box-body no-padding">
                <div class="mailbox-read-info">
                  <h5><a href="media_research-top.php?id=<?php echo $mediaID; ?>"><i class="fa fa-angle-left margin-r-5"></i> 報告一覧に戻る</a>
                  ...
                  <div class="mailbox-read-message">
                    ...
                    <div class="row">
                      <div class="col-sm-3 col-xs-6">
                        ...
                        <p class="text-muted"><?php echo $report['media_user']; ?></p>
                      </div>
                ...
                <div class="row margin">
                  <div class="col-md-9">
                    <h4>報告画像</h4>
                     ...
                     <img src="<?php echo $media_1;?>" width="200" height="200"
                     alt="title" onerror="this.style.display='none'"/>
                     <img src="<?php echo $media_2;?>" width="200" height="200"　
                     alt="title" onerror="this.style.display='none'"/>
                     <img src="<?php echo $media_3;?>" width="200" height="200"　
                     alt="title" onerror="this.style.display='none'"/>
  ...
  <script>
   // var ctx = document.getElementById("myChart").getContext('2d');
    ...
    for (var i = 0; i < 1; i++) {
      ...
      array[i][2] = <?php echo $report['media_user']; ?> ;
