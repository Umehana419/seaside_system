...
//        }
   ...
   echo  $activ_name, $start, $end, $activ_details, $activ_target, $activ_overview, $date;
        ...
        $stmt = $pdo->prepare("INSERT INTO media_search(media_name, media_details,  media_target, media_overview, date, media_start, media_end) VALUES (?, ?, ?, ?, ?, ?, ?)");
...
//         }
        ...
        header("Location: media_research-top.php?id= $id");
