       ...
       $stmt->execute(array($debrisID));
        ...
        if ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
           ...
           // $researchType = $row['researchType'];
            ...
            // 全ての報告情報の取得（省略可能）
            $stmt = $pdo->prepare('SELECT * FROM debris_report WHERE debrisID = :ID');
            $stmt->execute(array(':ID' => $debrisID));
            ...
            $_SESSION["login_id"] = "id00001";
                    $comment = '<img src="'. $row['media'] .'" class="img-responsive" alt=""><p>報告日:'. $row['date'] . '<br>報告者:'. $row['debris_user'] .'</p>';
                    $comment .= '<a href="debris-report-detail.php?id='. $debrisID .'&report='. $row['debris_reID'] .'">詳細情報を確認</a>';
...
while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
  ...
  $debris[] = array('debris_name' => $row['debris_name'], 'debrisID' => $row['debrisID'], 'debris_start' => $row['debris_start'], 'debris_end' => $row['rdebris_end'], 'debris_details' => $row['debris_details']);
}
      ...
      <section class="content">
        ...
        <div class="box box-widget widget-user">
          ...
          <div class="widget-user-header bg-teal-active">
            <h3 class="widget-user-username"><?php echo $value['debris_name']; ?> <?php echo $researchYear; ?></h3>
          ...
          <div class="box-footer">
            ...
            <p class="text-muted"><?php echo $value['debris_details']; ?></p>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-xs-6">
            ...
            <div class="small-box bg-red">
              <div class="inner">
                <h3><?php echo $debris_Date; ?><sup style="font-size: 20px"></sup></h3>
                <p>調査開始日</p>
              </div>
              <div class="icon">
        ...
        <div class="row">
          ...
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-xs-6">
                  <button type="button" name="button" class="btn btn-primary btn-block btn-lg" onclick="location.href='debris_report.php?id=<?php echo $value['debrisID']; ?>'">報告を行う</button>
                </div>
                <!-- <div class="col-xs-6">
