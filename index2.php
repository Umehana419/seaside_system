...
foreach ($activity as $key => $value) {
    echo <<<EOM
                          <tr role="row">
                            ...
                            <td>{$value['researchStart']} ~ {$value['researchEnd']}</td>
                            <td><span class="label label-{$statusCollor}">{$status}</span></td>
                            <td>{$value['activ_name']}<br>
                            <button type="button" class="btn btn-info btn-flat" onclick="location.href='activ_research-top.php?id={$value['activityID']}'">調査ページへ</button></td>
                            <td>活動報告</td>
                          </tr>
EOM;
...
foreach ($media as $key => $value) {
    echo <<<EOM
                                                 <tr role="row">
                                                   <td>{$value['mediaID']}</td>
                                                   <td>{$value['media_start']} ~ {$value['media_end']}</td>
                                                   <td><span class="label label-{$statusCollor}">{$status}</span></td>
                                                   <td>{$value['media_name']}<br>
                                                   <button type="button" class="btn btn-info btn-flat" onclick="location.href='media_research-top.php?id={$value['mediaID']}'">調査ページへ</button></td>
                                                   <td>海岸状況報告</td>
                                                 </tr>
                       EOM;
...
foreach ($debris as $key => $value) {
    echo <<<EOM
                                                                       <tr role="row">
                                                                         <td>{$value['debrisID']}</td>
                                                                         <td>{$value['debris_start']} ~ {$value['media_end']}</td>
                                                                         <td><span class="label label-{$statusCollor}">{$status}</span></td>
                                                                         <td>{$value['debris_name']}<br>
                                                                         <button type="button" class="btn btn-info btn-flat" onclick="location.href='debris_research-top.php?id={$value['debrisID']}'">調査ページへ</button></td>
                                                                         <td>海岸ごみ報告</td>
                                                                       </tr>
                                             EOM;
