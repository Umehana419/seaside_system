...
//        }
   ...
   echo  $activ_name, $start, $end, $activ_details, $activ_target, $activ_overview, $date;
        ...
        $stmt = $pdo->prepare("INSERT INTO debris(debris_name, debris_details,  debris_target, debris_overview, date, debris_start, debris_end) VALUES (?, ?, ?, ?, ?, ?, ?)");
       $stmt->execute(array( $activ_name, $activ_details,  $activ_target, $activ_overview, $date, $start, $end));
...
//         }
        ...
        header("Location: debris_research-top.php?id= $id");
